package pas.gV.data.repositories;
...
import pas.gV.data.datahandling.dto.UserDTO;
import pas.gV.data.datahandling.mappers.AdminMapper;
import pas.gV.data.datahandling.mappers.ClientMapper;
import pas.gV.data.datahandling.mappers.ResourceAdminMapper;
...
public class UserMongoRepository extends AbstractMongoRepository<User> {
    ...
    public User create(User initUser) {
        ...
        if (initUser instanceof Client client) {
            newUser = new Client(UUID.randomUUID(), client.getFirstName(), client.getLastName(),
                    client.getClientTypeName(), client.getLogin(), "");
    ...
    private void init() {
        ...
        createNew(ClientMapper.toMongoUser(new Client(UUID.fromString("80e62401-6517-4392-856c-e22ef5f3d6a2"), "Johnny", "Brown", "normal", "login", "")));
        createNew(ClientMapper.toMongoUser(new Client(UUID.fromString("b6f5bcb8-7f01-4470-8238-cc3320326157"), "Rose", "Tetris", "athlete", "login15", "")));
        createNew(ClientMapper.toMongoUser(new Client(UUID.fromString("6dc63417-0a21-462c-a97a-e0bf6055a3ea"), "John", "Lee", "coach", "leeJo15", "")));
        createNew(ClientMapper.toMongoUser(new Client(UUID.fromString("3a722080-9668-42a2-9788-4695a4b9f5a7"), "Krzysztof", "Scala", "normal", "scKrzy", "")));
        createNew(ClientMapper.toMongoUser(new Client(UUID.fromString("126778af-0e19-46d4-b329-0b6b92548f9a"), "Adam", "Scout", "normal", "scAdam", "")));
